...
import styles from '../styles/OcrModel.module.css'; 
import axios from 'axios';

// Update the API URL to avoid trailing slash
const API_URL = 'https://ocrscript.duckdns.org'; 
...
const OcrModel = () => {
  ...
  const performOcr = async (file) => {
    ...
    try {
      ...
      const response = await axios.post(`${API_URL}/extract_text`, formData, {
        headers: {
      ...
      setOcrResult(data.product_details);

    } catch (err) {
      // Log detailed error information
      console.error('Error performing OCR:', err.response ? err.response.data : err.message);
          ...
          <div className={styles.detailsSection}>
            ...
            <div className={styles.metricsGrid}>
              ...
              <div className={styles.metricCard}>
                ...
                <div>
                  <h3>Best Before</h3>
                  <p>{ocrResult ? ocrResult['Best Before'] || 'N/A' : 'N/A'}</p>
                </div>
              </div>
              ...
              <div className={styles.metricCard}>
                ...
                <div>
                  <h3>Net Weight</h3>
                  <p>{ocrResult ? ocrResult['Net Weight'] || 'N/A' : 'N/A'}</p>
                </div>
              </div>
              ...
              <div className={styles.metricCard}>
                ...
                <div>
                  <h3>Expiry Date</h3>
                  <p>{ocrResult ? ocrResult['Expiry Date'] || 'N/A' : 'N/A'}</p>
                </div>
              </div>
